...
function Footer() {
  return (
    <footer className=" h-[50vh] w-full bg-Secondary4 justify-center items-center inline-flex">
      <div className="grow shrink basis-0 justify-center items-start gap-48 flex">
        ...
        <div className="w-28 h-full pt-px flex-col justify-end items-start gap-8 inline-flex text-Secondary3">
        ...
        <div className="h-full flex-col gap-8 flex text-Secondary3 items-start justify-start">
